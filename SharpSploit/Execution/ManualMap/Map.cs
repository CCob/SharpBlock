...
namespace SharpSploit.Execution.ManualMap
{
    public class Map
    {
        ...
        public static void RelocateModule(PE.PE_META_DATA PEINFO, IntPtr ModuleMemoryBase, IntPtr FinalModuleMemoryBase)
        {            
            if(FinalModuleMemoryBase == IntPtr.Zero) {
                FinalModuleMemoryBase = ModuleMemoryBase;
            }
        ...
        public static PE.PE_MANUAL_MAP MapModuleToMemory(IntPtr pModule, IntPtr pImage, PE.PE_META_DATA PEINFO)
        {
            ...
            // Perform relocations
            RelocateModule(PEINFO, pImage, pImage);
